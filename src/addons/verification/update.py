            ...
            if len_users > 1:
                ...
                try:
                    ...
                    if b.guild_restriction:
                        raise Message(f"This user is server-restricted from using Bloxlink for: `{b.message}`. This is NOT a Bloxlink blacklist.")
                    else:
                        raise Message(f"This user is blacklisted from using Bloxlink for: `{b.message}`.")
